 ...
 * @author Macklon
 */
public class bodr extends javax.swing.JFrame {

    dbconnect db=new dbconnect();  
    
    /**
     * Creates new form bodr
     */
    public bodr() {
        initComponents();
        
        lbbodr.setText(Login.bsource+" to "+Login.bdestination);
        fillCombo();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
            String board=cboard.getSelectedItem().toString();
            String drop=cdrop.getSelectedItem().toString();
            db.connect();
            String sql="select bd_id from bodr where boarding=? and droping=?";
            db.pst= db.con.prepareStatement(sql);
            db.pst.setString(1,board);
            db.pst.setString(2,drop);
            
            db.rs=db.pst.executeQuery();
           
            if(db.rs.next()){
                Login.bd_id=db.rs.getInt("bd_id");
    ...
    private void fillCombo(){
             try{
            db.connect();
            String sql="select * from bodr where bid=?";
            db.pst= db.con.prepareStatement(sql);
            db.pst.setInt(1,Login.bid);
            db.rs=db.pst.executeQuery();
           
            while(db.rs.next()){
                cboard.addItem(db.rs.getString(3));
                cdrop.addItem(db.rs.getString(4));
            }
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null,e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bodr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> cboard;
    private javax.swing.JComboBox<String> cdrop;
    ...
    public javax.swing.JLabel lbbodr;
